...
- `schemas/profit.schema.json` defines the structured profitability record.
- `docs/product-sale-skill-verification.md` defines the product-sale skill flow and dataset safety rules.
- `examples/profitability_example.py` shows SDK usage.
